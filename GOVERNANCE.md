...
This document defines how the Gideon Christian Open Source License (GCOSL) is maintained, who has authority to modify it, and what principles govern its evolution.

GCOSL is designed for stability. It is not a living document that shifts with trends, public pressure, or commercial convenience. Changes to the license are rare, deliberate, and subject to strict constraints.
...
### 1. Restrictions Are Intentional
...
GCOSL prioritizes long-term moral consistency over rapid adaptation. The license is not versioned on a release schedule. New versions are issued only when a substantive change is necessary and has been thoroughly reviewed.

Minor clarifications that do not alter the meaning or scope of the license may be issued as errata without a version increment.

### 3. No Erosion by Precedent

The fact that a particular use was previously tolerated, overlooked, or not enforced does not create a right to that use. Non-enforcement is not approval. GCOSL may be enforced at any time against any violation, regardless of prior history.
...
- The version number of the new license text.
- The date of the change.
- A plain-English summary of what changed and why.
- The full text of the previous version, preserved in the repository history.

Changes will not be made silently or retroactively.
